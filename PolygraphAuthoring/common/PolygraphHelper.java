...
public class PolygraphHelper {
    ...
    public static String KAFKA_HOSTS="10.0.0.205:9092";// IP:PROT, ...
    ...
    public static String getLogRecordString(char type, String actionName, String recordKey, long startTime, long endTime, ArrayList<Entity> entitiesArr) {
        ...
        concatWithSeperator(RECORD_ATTRIBUTE_SEPERATOR, String.valueOf(type), actionName, recordKey, String.valueOf(startTime), String.valueOf(endTime), generateEntitiesString(entitiesArr));
        return sb.toString();
    }
