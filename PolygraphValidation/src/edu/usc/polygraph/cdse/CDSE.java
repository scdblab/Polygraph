...
//		schedules.add(getSchedule(input));
	...
	private static ArrayList<Tree> constructTrees(Validator validator,ArrayList<LogRecord> input, Graph<LogRecord> g, HashSet<String> items, long maxStart,HashMap<LogRecord, HashSet<String>> transItems, Map<String, Map<String, Boolean>> notAllowedList) {
	...
	private static void buildTree(Validator validator,Tree tree, Graph<LogRecord> g, Node n, Vertex<LogRecord> v, HashMap<LogRecord, HashSet<String>> transItems, Map<String, Map<String, Boolean>> notAllowedList) {
...
//				System.out.println();
	...
	public static ArrayList<LogRecord> runAlg(Validator validator, LogRecord read, Map<String, Map<String, Boolean>> notAllowedList,
...
//			System.out.println();
	...
	private static ArrayList<LogRecord> runLogs(ArrayList<LogRecord> input, Validator validator, LogRecord read, Map<String, Map<String, Boolean>> notAllowedList) {
