...
import edu.usc.polygraph.treemap.StringTreeType;
...
public class ValidationParams {
	...
	public static TreeType treeMapObj = new IntegerTreeType();
	public static boolean scanHoles = true;
	public static boolean integerScan = true;
	public static final boolean OPTIMIZE_SCAN = true;
	...
	public final static String ZOOK_HOST_PROP = "zookhosts";
	public final static String KAFKA_HOST_PROP = "kafkahosts";
	public static String KAFKA_HOST = "10.0.0.240:9092";// ,10.0.0.106:9092,10.0.0.240:9092,10.0.0.235:9092,10.0.0.200:9092";//"10.0.0.145:9092"
														// ;
	public static boolean PRINT_ALL_STATS = false;
	...
	public static String READ_MAX_PARTITION_FETCH_BYTES = "1048576";// "1048576";//"23000"; //200 BG TPCC 1000 (400
																	// read)
	public static String UPDATE_MAX_PARTITION_FETCH_BYTES = "1048576";// "1048576";//"23000";//"1500"; buffered 1500
																		// //1000 for BG and TPCC
	...
	// =bg -p =false -p kafka=true -p globalschedule=false -p er= -p filelogdir= -p
	// kafkalogdir=
	...
	public final static String FRESHNESS_PROP = "freshness";
	...
	public static final String SKEW_PROP = "skew";
	...
	public static boolean useTreeMap = false;
	public static boolean timePartition = false;
	public static boolean readAllFiles = false;
	...
	public static boolean COMPUTE_FRESHNESS = false;
	public static boolean PRINT_EXPECTED = true;
	public static final String USE_INTERVAL_TREE_PROP = "tree";
	public static final String USE_DATABASE_PROP = "database";
	public static final String THREADS_PER_PARTITION_PROP = "threadsperpartition";
	public static final String PARTITION_DURATION_PROP = "partitionduration";

	public static final boolean OLTP_SCAN = false;
	public static final boolean ANOMALY_EXIT = false;

	public static long maxBufferSize = 1000;// 1024*50;//// *300; // 1024=10 logs
	// //
	// 100
	// 512
	// 1024
	public static float bufferThreshold = 0.75f;
	...
	public static int DELIVERY_DATE_DIVISION = 1000; // This used to discard digits from the delivery date in millis to
														// match retrieved time stamp;

	public static final String[] CUST_ORDER_REL_PROPERIES = { CUSTOMER_ENTITY, ORDER_ENTITY };
	public static final String[] CUSTOMER_PROPERIES = { CUSTOMER_BALANCE, CUSTOMER_YTD_PAYMENT,
	...
	public static final String[] USER_PROPERIES = { "FIELD0", "FIELD1", "FIELD2", "FIELD3", "FIELD4", "FIELD5",
			"FIELD6", "FIELD7", "FIELD8", "FIELD9" };
	// public static final String[] USER_PROPERIES = { "F1", "F2", "F3", "F4", "F5",
	// "F6", "F7", "F8", "F9", "F10","F0"};
