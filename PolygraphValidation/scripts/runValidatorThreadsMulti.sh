...
./stopStartServers.sh 10.0.0.200,10.0.0.205,10.0.0.240,10.0.0.235,10.0.0.106
sleep 20
...
ssh -n -f 10.0.0.210 screen -L -S validator -dm "java -Xmx12G -cp /home/mr1/StaleMeter:/home/mr1/StaleMeter/bin:/home/mr1/StaleMeter/libs/*:/home/mr1/StaleMeter/kafkaServer/libs/* edu.usc.stalemeter.ValidationMain -numvalidators $numV -numpartitions $numP -clientid $clientid -numclients 2 -app $topic -init false -kafka true -validation $valid -printfreq 400000 -globalschedule false -kafkaosstats false -kafkalogdir /home/mr1/StaleMeter/kafkatests"
