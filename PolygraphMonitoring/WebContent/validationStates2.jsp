...
<body id="body" style="text-align: center;">
						...
						<tr>
							<td>
								<table class="evenOdd" style="margin-left: auto; margin-right: auto; width: 140px; border-collapse: collapse;">
									...
									<tr>
										<td style="text-align: left;">Anomalies count</td>
									</tr>
									<tr>
	...
	<table style="margin-left: auto; margin-right: auto;">
		...
		<br />
		<br />
		<div id="fdiv" class="shadow" style="visibility:hidden; width:740px">
	 <table style="margin-left: auto; margin-right: auto;" >
	 <tr>
	 
	 <td align="left" style="padding-left: 40px;padding-top:0px; font-size:18px; font-weight: normal;"> <label id="flabel">Freshness Confidence (%)</label>
	 </td>
	 </tr>
	 <tr>
	 <td colspan="2" >
	 <div id="visualization"  style="border:none !important;padding: 2px; overflow: auto; margin: auto;" >  
     </div>
     </td>
     </tr>
      <tr>
	 
	 <td align="center" style="padding-left: 40px;padding-top:0px; font-size:18px; font-weight: normal;"> <label id="tlabel">Elapsed time since last write</label>
	 </td>
	 </tr>
     </table>
     </div>
